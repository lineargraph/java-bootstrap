        ...
        srcs =
          ...
          [
            ...
            (fetchFromGitHub {
              ...
              repo = "eclipse.platform.resources";
              inherit rev;
              hash = "sha256-7WfdxG78gEKOR+78zDRJZIGo6Oi+AXA9Rb/raOXm4xg=";
            })
            (fetchFromGitHub {
              ...
              inherit rev;
              hash = "sha256-lsz83IJ8ewS+LM5+YOdjNNl9/iaoPW19mr6G1aVUZrY=";
            })
            (fetchFromGitHub {
              name = "eclipse-platform-runtime";
              owner = "eclipse-platform";
              repo = "eclipse.platform.runtime";
              inherit rev;
              hash = "sha256-lCWAHQtIulC6w4zUn6QPwjKu1BqaZ4uwhfoLWivxMuc=";
            })
            (fetchFromGitHub {
              name = "equinox.bundles";
              owner = "eclipse-equinox";
              repo = "equinox.bundles";
              inherit rev;
              hash = "sha256-fM0KR7oUadOit0xQjZjnYKuwk9jffSk/87FvJOTev94=";
            })
            (fetchFromGitHub {
              name = "equinox.framework";
              owner = "eclipse-equinox";
              repo = "equinox.framework";
              inherit rev;
              hash = "sha256-C6/obyyzaYU/0EmJMIIk9oKpTjgupPYqQzQu37TP8A0=";
            })
            #            (fetchFromGitHub {
            #              name = "eclipse-equinox";
            #              owner = "eclipse-equinox";
            #              repo = "equinox";
            #              rev = "0ff9893cd43bace07b119af983f3c4ac74b98194";
            #              hash = "sha256-nI7SCNh5RQi2TCXx1XmZDWKy8+tyT927W8Tg+y2BbFA=";
            #            })
            (fetchFromGitHub {
              name = "eclipse-platform-text";
              owner = "eclipse-platform";
